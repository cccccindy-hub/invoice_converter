...
public class SysDictDataServiceImpl implements ISysDictDataService {
    ...
    @Override
    public Map<String, List<SysDictData>> selectDictDataByType(Collection<String> dictTypes) {
        if (CollUtil.isEmpty(dictTypes)) {
            return new HashMap<>();
        }
        return Optional.ofNullable(dictDataMapper.selectDictDataByTypes(dictTypes)).orElse(new ArrayList<>())
                .stream()
