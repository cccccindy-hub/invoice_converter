<template>
  <el-select class="er-select" v-model="selectValue" :multiple="multiple" filterable remote reserve-keyword placeholder="请输入法人姓名" :remote-method="remoteMethod" :loading="loading" collapse-tags collapse-tags-tooltip clearable :style="{width:width||'auto'}" :disabled="disabled">
